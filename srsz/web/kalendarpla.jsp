               ...
               /* var czyDodaje = %= dUprawnienie.czyPosiadaUprawnienie(usr, zasobId, 1)%>;
                ...
                $(document).ready(function () {
                    ...
                    var calendar = $('#calendar').fullCalendar({
                        ...
                        height:'auto',
                        events: "<portlet:resourceURL><portlet:param name="jspPage" value="/pliki/kier1.jsp" /></portlet:resourceURL>&kier=7",
                        type: "resource",
                        timeFormat: 'H(:mm)',
                        selectOverlap: false,
                        eventOverlap: false,
  ...
  margin: 10px;
        ...
        <br></br>
                ...
                <form id="selectyzas">
                    ...
                    <%
                   List<baza.Kierunek> KList = baza.DaneKierunek.selectKierunek();
...
function pokazpla(){
    var pobierz = $('#selectzasoby').val();

                    var osoSize = <%=osSize%>;
                    var i;
                    for (i = 0; i < osoSize; i++) {
                        $('#calendar').fullCalendar('removeEventSource', '<portlet:resourceURL><portlet:param name="jspPage" value="/pliki/kier1.jsp" /></portlet:resourceURL>&kier=' + i);
                        $('#calendar').fullCalendar('removeEventSource', '<portlet:resourceURL><portlet:param name="jspPage" value="/pliki/kier1.jsp" /></portlet:resourceURL>');
                    }
                    if ($('#calendar').fullCalendar('clientEvents') == '') {
                        ...
                        $('#calendar').fullCalendar('addEventSource', '<portlet:resourceURL><portlet:param name="jspPage" value="/pliki/kier1.jsp" /></portlet:resourceURL>&kier=' + pobierz);
...
$( "#check" ).button();
        ...
        $(document).ready(function () {
            ...
            /*if (!%=dUprawnienie.czyPosiadaUprawnienie(usr, zasobId, 12)%>) {

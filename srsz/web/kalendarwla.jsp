            ...
            <script>
                $(document).ready(function () {
                    ...
                    var calendar = $('#calendar').fullCalendar({
                        ...
                        height:'auto',
                        events: "<portlet:resourceURL><portlet:param name="jspPage" value="/pliki/wlasc1.jsp" /></portlet:resourceURL>&wlasc=0",
                        type: "resource",
                        timeFormat: 'H(:mm)',
                        selectOverlap: false,
                        eventOverlap: false,
...
.przyciskii a{
 ...
 <a id="button12" href="<portlet:renderURL><portlet:param name="jspPage" value="/kalendar.jsp" /></portlet:renderURL>">Rezerwacja</a>
        ...
        <br></br>
                ...
                <form id="selectyzas">
                    <select id="selectzasoby" name="zasob" size="6">
                    <%
    ...
    <script>
        ...
        function pokazwla(){
             var pobierz = $('#selectzasoby').val();
                    ...
                    var i;
                    for (i = 0; i < osoSize; i++) {
                        $('#calendar').fullCalendar('removeEventSource', '<portlet:resourceURL><portlet:param name="jspPage" value="/pliki/wlasc1.jsp" /></portlet:resourceURL>&wlasc=' + i);
                        $('#calendar').fullCalendar('removeEventSource', '<portlet:resourceURL><portlet:param name="jspPage" value="/pliki/wlasc1.jsp" /></portlet:resourceURL>');
                    }
                    if ($('#calendar').fullCalendar('clientEvents') == '') {
                        ...
                        $('#calendar').fullCalendar('addEventSource', '<portlet:resourceURL><portlet:param name="jspPage" value="/pliki/wlasc1.jsp" /></portlet:resourceURL>&wlasc=' + pobierz);

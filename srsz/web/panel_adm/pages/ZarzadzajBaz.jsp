<%@page errorPage="/WEB-INF/error.jsp"%> <%@page contentType="text/html" pageEncoding="UTF-8"%>
...
<div class='srsz_space'></div>
  ...
  <li><a href='<portlet:renderURL><portlet:param name="jspPage" value="/panel_adm/pages/Prosby.jsp" /></portlet:renderURL>' style="text-decoration: none">Prośby</a></li>
        ...
        <nav id="mainNav" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
                <div class="menu-item">
                    <input type="radio" id="radio1" name="menu" checked/><label for="radio1"><a href ="<portlet:renderURL><portlet:param name="jspPage" value="/panel_adm/pages/ZarzadzajBaz.jsp" /></portlet:renderURL>">Zarządzaj bazą</br></a></label>
                </div>
               <div class="menu-item">
...
<div id="tabs-1">
		<h2 class="demoHeaders">Wybierz opcję</h2>
<select id="selectmenu" style="box-shadow: 10px 10px 5px #888888;">
    <option value="">Wybierz z menu</option>
	<option value="<portlet:renderURL><portlet:param name="jspPage" value="/panel_adm/pages/Osoby.jsp" /></portlet:renderURL>">Baza osób</option>
	
        <option value="<portlet:renderURL><portlet:param name="jspPage" value="/panel_adm/pages/Zasoby.jsp" /></portlet:renderURL>">Baza zasobów</option>
        <option value="<portlet:renderURL><portlet:param name="jspPage" value="/panel_adm/pages/Prosby.jsp" /></portlet:renderURL>">Baza próśb</option>
        <option value="<portlet:renderURL><portlet:param name="jspPage" value="/panel_adm/pages/Zwolnienia.jsp" /></portlet:renderURL>">Baza zwolnień</option>
        <option value="<portlet:renderURL><portlet:param name="jspPage" value="/panel_adm/pages/Rezerwacja.jsp" /></portlet:renderURL>">Baza rezerwacji</option>
...
<script src="/srsz/panel_adm/pages/ZarzadzajBaza.js"></script>
<script>
